...
Pod::Spec.new do |s|
  s.name             = 'WKCategoryLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WKCategoryLib.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'wuchaorang.2008@163.com' => 'wuchaorang.2008@163.com' }
  ...
  # s.resource_bundles = {
  #   'WKCategoryLib' => ['WKCategoryLib/Assets/*.png']
  # }
